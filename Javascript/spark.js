...
const sparkles = 50; // total number of stars, same as number of dots
const sparkle_lifetime = 5; // each star lives for twice this, then turns into a dot that also lives twice this
